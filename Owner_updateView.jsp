...
<style>
	...
	<div id="wrapper">
		...
		<div id="main">
			...
			<section id="container">
				<form name="updateForm" role="form" method="post" action="/board/Owner_update.do" enctype="multipart/form-data">
	...
	$(document).ready(function(){
		...
		$(".cancel_btn").on("click", function(){
			...
			location.href = "/Owner_readView.do?bno=${update.bno}"
				   + "&page=${scri.page}"
		...
		$(".update_btn").on("click", function(){
			...
			formObj.attr("action", "/Owner_update.do");
