				...
				<!-- Content -->
					<section>
						<header class="main" align="center">
							<img src="./images/recipebbslist.png"/><br><br>
							
				<!-- Break -->
					<div class="col-12" align="center">
							<select name="demo-category" id="demo-category">
								<option value="">- Category -</option>
								<option value="./list.do">나만의 음료</option>
								<option value="1">나만 알고 싶은 카페</option>																	
							</select>
					</div>
				<!-- Break -->
					...
					<table> 
						...
						<c:forEach items="${list}" var = "list">
							<tr>
								...
								<td>
									<a href="./Show_readView.do?bno=${list.bno}&
					...
					<div class="search row" >
					    ...
					    <script>
					      $(function(){
					        $('#searchBtn').click(function() {
					          self.location = "Show_list.do" + '${pageMaker.makeQuery(1)}' + "&searchType=" + 
					  ...
					  <ul>
					    <c:if test="${pageMaker.prev}">
					    	<li><a href="Show_list.do${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
					    </c:if> 
					
					    <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
					    	<li><a href="Show_list.do${pageMaker.makeSearch(idx)}">${idx}</a></li>
					    </c:forEach>
					
					    <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
					    	<li><a href="Show_list.do${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
					    </c:if> 
					  </ul>
