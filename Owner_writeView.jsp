			...
			<div class="inner">
				...
				<!-- Content -->
						<section>
							...
							<img src="./images/cafebbswrite.png"/></br></br>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".write_btn").on("click", function(){
				...
				formObj.attr("action", "/Owner_write.do");
...
<section id="container">
				<form role="writeForm" method="post" action="./Owner_write.do" enctype="multipart/form-data">
					<table  align="center">
						<tbody  align="center">
							<tr>
								<td>
