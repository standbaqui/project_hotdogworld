			...
			<div class="inner">
				...
				<!-- Content -->
						<section>
							...
							<img src="./images/recipebbswrite.png"/></br></br>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".write_btn").on("click", function(){
				...
				formObj.attr("action", "./Show_write.do");
...
<section id="container">
				<form role="writeForm" method="post" action="Show_write.do" enctype="multipart/form-data" align="center">
