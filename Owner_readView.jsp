	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".update_btn").on("click", function(){
				formObj.attr("action", "./Owner_updateView.do");
			...
			$(".delete_btn").on("click", function(){
				...
				formObj.attr("action", "./Owner_delete.do");
			...
			// 목록
				...
				location.href = "./Owner_list.do?page=${scri.page}"
				...
				$(".replyWriteBtn").on("click", function(){
				  ...
				  formObj.attr("action", "./Owner_replyWrite.do");
				  formObj.submit();
				});
			
			//댓글 수정 View
			$(".replyUpdateBtn").on("click", function(){
				location.href = "./Owner_replyUpdateView.do?bno=${read.bno}"
								+ "&page=${scri.page}"
								+ "&perPageNum=${scri.perPageNum}"
			...
			$(".replyDeleteBtn").on("click", function(){
				location.href = "./Owner_replyDeleteView.do?bno=${read.bno}"
					+ "&page=${scri.page}"
					+ "&perPageNum=${scri.perPageNum}"
					+ "&searchType=${scri.searchType}"
					+ "&keyword=${scri.keyword}"
		...
		function fn_fileDown(fileNo){
			...
			formObj.attr("action", "./Owner_fileDown.do");
			formObj.submit();
		}
	</script>
