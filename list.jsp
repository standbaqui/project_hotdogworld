				...
				<!-- Content -->
					<section>
						<header class="main" align="center">
							<img src="./images/normalbbslist.png"/></br></br>
			
			<button><a href="./list.do" type="button">목록</a></button>
			<button><a href="./writeView.do" type="button">글 작성</a></button>
					...
					<table> 
						...
						<c:forEach items="${list}" var = "list">
							<tr>
								...
								<td>
									<a href="/readView.do?bno=${list.bno}&
					...
					<div class="search row">
						...
						<div class="col-xs-10 col-sm-10">
							<div class="input-group">
								...
								<button id="searchBtn" type="button" class="myButton">검색</button>
					    ...
					    <script>
					      $(function(){
					        $('#searchBtn').click(function() {
					          self.location = "list.do" + '${pageMaker.makeQuery(1)}' + "&searchType=" + 
